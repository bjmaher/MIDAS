...
# __parcs343exe__ = "/usr/local/usrapps/ardor/shared/parcs_tmp/ex/parcs-v345-linux2-intel-x64-release.x" # HAZEL Parcs 345 location
...
#__ipwr_lut__ = "/usr/local/usrapps/ardor/shared/Simulate_IPWR_DB/" # HAZEL IPWR LUT legacy
__ipwr_lut__ = "/usr/local/usrapps/ardor/shared/Simulate_IPWR_DB/parquet/IPWR_DB.parquet" # HAZEL IPWR LUT updated
#__ipwr_lut__ = "/data/oldcluster/cm_shared/databases/SMR_IPWR_DATABASE/IPWR_DB.parquet" # RDFMG IPWR LUT location
#__ipwr_lut__ = "/data/oldcluster/cm_shared/databases/SMR_IPWR_DATABASE/" # RDFMG IPWR LUT location legacy